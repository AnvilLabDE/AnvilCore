...
/**
 * Kümmert sich um diverse auf die Konsole bezogene Aufgaben
 * 
 * @author Minefabser
 */
public class ConsoleHandler {
	...
	/**
	 * Sendet eine Nachricht an die Konsole, unterstützt Farbe
	 * 
	 * @param Nachricht
	...
	/**
	 * Konvertiert {@link ChatColor}s zu ihren {@link Ansi} Gegenstücken
	 * 
	 * @param Zu konvertierender String
	 * @return Konvertierter String
	 */
	public static String convertColorToAnsi(String input) {
	...
	/**
	 * Setzt die Map mit den {@link Ansi} Gegenstücken zu den {@link ChatColor}s auf
	 * 
	 * @src https://github.com/Bukkit/CraftBukkit/blob/master/src/main/java/org/bukkit/craftbukkit/command/ColouredConsoleSender.java
	 */
